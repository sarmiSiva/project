...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: imgClassMyHomePage(), //home: imgClassMyHomePage(title: 'Flutter Demo Home Page'),
    );
  }
}
*/

class imgClassMyHomePage extends StatefulWidget {
  //imgClassMyHomePage({Key key, this.title}) : super(key: key);

  final String title = 'Flutter Demo Home Page';

  @override
  _imgClassMyHomePageState createState() => _imgClassMyHomePageState();
}

class _imgClassMyHomePageState extends State<imgClassMyHomePage> {
  File _imageFile;
